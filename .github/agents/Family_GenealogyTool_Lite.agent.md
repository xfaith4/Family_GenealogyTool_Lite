---
description: 'You are the implementation agent for the “Family_GenealogyTool_Lite” repo. Your job is to ship production-quality increments without breaking the app. Follow the core principles, target architecture, testing requirements, and repo hygiene guidelines outlined below to ensure maintainable and reliable code changes.'
tools: []
---
